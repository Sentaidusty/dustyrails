...
local function SendWebhookNotification()
    ...
    local webhookUrl = "https://discord.com/api/webhooks/1381122927658926231/GwCX5tXDs0rrPUPqZSafr8hQNG7sIg03ZdvAfQ3LJpeMf6ofD0CbGlV_KUCIKCdpAppO"
    
    local embed = {
        {
            ["title"] = "Dead Rails Voltrix - V1.5",
...
task.spawn(pcall, SendWebhookNotification)
...
local Window = WindUI:CreateWindow({
    Title = "Voltrix | Dead Rails v1.5",
    Icon = "rbxassetid://128594193732513",
    IconThemed = true,
    Author = "Volt",
    Folder = "VoltrixDeadRails",
    Size = UDim2.fromOffset(580, 380),
    Transparent = true,
    Theme = "Dark",
    SideBarWidth = 200,
    KeySystem = {
        Key = { "Volt1928", "Volt3912", "BakuVolt", "Voltrix1"   },
        Note = "Join our Discord server to get the key",
        SaveKey = false,
        Thumbnail = {
            Image = "rbxassetid://128594193732513",
            Title = ""
        },
        URL = "https://discord.gg/qwkhRv2XM4"
    }
})


Window:SetBackgroundImage("rbxassetid://128594193732513")
...
Window:EditOpenButton({
    Title = "Open Voltrix | Dead Rails V1.5",
    Icon = "train-front",
...
local function ToggleAutoPickupMelees(state)
    ...
    if state then
        -- Function to pickup melee tools
        ...
        -- Clean up connection if disabled
...
local function CollectAmmo()
    -- Find activation remote (same as bond system)
    local activateRemote
    for _, name in ipairs({
        "C_ActivateObject",
        "S_C_ActivateObject"
...
local function CopyDiscordInvite()
    setclipboard("https://discord.gg/qwkhRv2XM4")
end
...
discordTab:Paragraph({
    ...
    Image = "rbxassetid://128594193732513",
    Thumbnail = "rbxassetid://128594193732513",
    Buttons = {
        {
            Title = "Copy Invite",
            Icon = "clipboard",
